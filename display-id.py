...
def bt():
    global relation,k1,total
    Patient_id = var.get()
    #url = "https://oauth.dicom.org.tw/fhir/Observation?subject="+Patient_id
    #url = "http://192.168.50.3:10610/gateway/fhir/Observation?subject="+Patient_id
    url = "http://hapi.fhir.org/baseR4/Observation?subject="+Patient_id
